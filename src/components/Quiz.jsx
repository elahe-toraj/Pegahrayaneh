    ...
    return (
        <div className="quiz-container">
            {!quizStarted ? (
                ...
                <div className="quiz-running">
                    <h1>کوییز تمام شد!</h1>
                    <p>امتیاز نهایی شما: {score}/{DATA.length * 10}</p>
                ...
                <div className="quiz-running">
                    ...
                    <div className="score-and-question-display">
                        <div className="score-display">امتیاز: {score}</div>
                        <div className="question-number-display">{currentQuestionIndex + 1}/{DATA.length}</div>
                    </div>
                    ...
                    <ul className="options-list">
                        {DATA[currentQuestionIndex].options.map((option, index) => (
                            <li
                                ...
                                className={`option-item ${isAnswered && index === correctOption
                                        ? 'correct'
